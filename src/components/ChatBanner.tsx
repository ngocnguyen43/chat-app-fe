                ...
                <div className='w-full flex items-center justify-center py-4 pb-16'>
                    <div className='flex flex-col gap-4 items-center justify-center'>
                        ...
                        <div className="w-full flex gap-2 items-center justify-center">
                            <button className="text-color-base-100 font-medium bg-surface-mix-300 w-[150px] py-2 rounded-lg hover:scale-105">Accept</button>
                            <button className='text-color-base-100 font-medium bg-surface-mix-300 w-[150px] py-2 rounded-lg hover:scale-105 transition-all'>Decline</button>
                        </div>
                    </div>
                </div> : null
            }
