            ...
            <div className="modal-box bg-surface-mix-200">
                ...
                <div className="modal-action">
                    <form method="dialog" className="flex gap-4">
                        <button className="btn bg-surface-mix-300 hover:opacity-95 outline-none border-none" onClick={onClose}>Cancel</button>
                        <button className="btn bg-surface-mix-300 hover:opacity-95 outline-none border-none" onClick={onConfirm}>{buttonLabel ?? "Confirm"}</button>
                    </form>
                </div>
            </div>
        </dialog>
