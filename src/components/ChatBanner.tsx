...
const ChatBanner: FunctionComponent = () => {
  ...
  const avatar = useMemo(() => {
    return otherParticipant
      ? isValidUrl(decodeURIComponent(otherParticipant.avatar))
        ? decodeURIComponent(otherParticipant.avatar)
        : 'https://d3lugnp3e3fusw.cloudfront.net/' + decodeURIComponent(otherParticipant.avatar)
      : undefined;
  }, [otherParticipant]);
  // console.log(!isGroup && !isFetchingNextPage && !state?.isBlocked);
