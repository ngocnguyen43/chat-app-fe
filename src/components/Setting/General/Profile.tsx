...
export default function Profile() {
  ...
  return (data && <div className="w-full p-10">
    <form className="w-full  flex flex-col gap-20 first-letter:items-center justify-center">
      <div className="w-full relative flex items-center justify-center">
        <img
          src={isValidUrl(data.profile.avatar) ? (data.profile.avatar as string) : (import.meta.env.VITE_BASE_RESOURCE + data.profile.avatar)}
          ref={imgRef}
      ...
      <div className="flex flex-col gap-14 w-full">
        <div className="w-full flex gap-8 items-center justify-center">
          <div className="flex items-center justify-start w-32">
            <label htmlFor="email-input" className="font-semibold ">Email</label>
          </div>
          <div className="w-full relative">
            <input type="email" id="email-input" className={clsx(
        ...
        <div className="w-full flex gap-8 items-center justify-center">
          <div className="flex items-center justify-start w-32">
            <label htmlFor="fullname-input" className="font-semibold ">Full Name</label>
          </div>
          <div className="w-full relative">
            <input type="text" id="fullname-input" className={clsx(
              'w-full font-medium py-2 px-2 bg-transparent absolute -bottom-5 rounded-lg border-[2px]  border-gray-500 focus:outline-none focus:border-[2px] focus:border-white',
              // errors.oldPassword ? 'border-red-400 focus:outline-none' : 'border-gray-300',
            )} />
          </div>
        ...
        <div className="w-full flex gap-8 items-center justify-center">
          <div className="flex items-center justify-start w-32">
            <label htmlFor="bio-input" className="font-semibold ">Bio</label>
          </div>
          <div className="w-full relative">
            <input type="text" id="bio-input" className={clsx(
              'w-full font-medium py-2 px-2 bg-transparent absolute -bottom-5 rounded-lg border-[2px]  border-gray-500 focus:outline-none focus:border-[2px] focus:border-white',
              // errors.oldPassword ? 'border-red-400 focus:outline-none' : 'border-gray-300',
            )} />
          </div>
