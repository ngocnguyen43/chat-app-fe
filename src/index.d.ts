...
declare module '@mojs/core' {
  ...
  declare namespace mojs {
    ...
    function addShape(name: string, shape: CustomShape);
    ...
    interface ShapeOptions {
       ...
       */
      parent?: string | Object | HTMLElement | null;
       ...
       */
      strokeWidth?: number | { [delta: string]: string } | Object;

      /**
       *  Stroke Dash Array.
       *  ∆ :: Units :: Possible values: [ number, string ]
       */
      strokeDasharray?: string | number | { [delta: string]: string };
    ...
    interface ShapeSwirlOptions extends ShapeOptions {
       ...
       *  [ 0..1 ]
       */
      pathScale?: number | { [delta: string]: number } | any[];

      /**
       *  Degree shift for sine path.
       *  ∆ :: [number] :: Degree shift for the sinusoidal path
       */
      degreeShift?: number | { [delta: string]: number } | any[];
       ...
       */
      scale?: number | { [delta: number]: number } | any;
  ...
  declare module 'mojs-player' {
    import { Timeline, Shape } from '@mojs/core';
